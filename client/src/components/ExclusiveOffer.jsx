    ...
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align='left' title='Exclusive Offers' subTitle='Take advantage of our limited-time offers and special packages to
             enhance youe stay and create unforgettable memories. '/>
    ...
    {/* display cards */}
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
         {exclusiveOffers.map((item) => (
            <div key={item._id} className='group relative flex flex-col items-start justify-between gap-1 
            pt-12 md:pt-18 px-4 rounded-xl text-white bg-no-repeat bg-cover bg-center'
              ...
              <p className='px-3 py-1 absolute top-4 left-4 text-xs bg-white
               ...
               <div>
                ...
                <button className='flex items-center gap-2 font-medium cursor-pointer mt-4 mb-5'>
                    ...
                    src={assets.arrowIcon} alt='arrowIcon'/>
                </button>
