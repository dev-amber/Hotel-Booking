     ...
     <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 bg-[#F6F9FC]'>
            ...
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    />
                    <p className='text-sm'>
                       Discover the world's most extraordinary places tp stay, from boutique hotels to luxury villas and private islands.
                    </p>
                    <div className='flex items-center gap-3 mt-4'>

                      
                       <img src={assets.instagramIcon} alt='instagramIcon' 
                       className='w-6'/>
                        <img src={assets.facebookIcon} alt='facebookIcon'
                        className='w-6'/>
                        <img src={assets.twitterIcon} alt='twitterIcon' 
                        className='w-6'/>
                        <img src={assets.linkendinIcon} alt='linkendinIcon' 
                       className='w-6'/>
